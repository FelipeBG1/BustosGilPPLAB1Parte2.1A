...
int altaTrabajo(int idX,eBicicleta bicicletas[], int tamBic,eTipo tipos[],int tamTip,eColor colores[],int tamCol,eTrabajo trabajos[],int tam,eServicio servicios[],int tamServ,eCliente clientes[], int tamCli)
{
    int todoOK = -1;
