...
int altaBicicleta(int idX,eBicicleta bicicletas[], int tamBic,eTipo tipos[],int tamTip,eColor colores[],int tamCol,eCliente clientes[],int tamCli)
{
    int todoOK = -1;
    ...
    else
    {
        while(todoOK==-1)
        {
           ...
           if((utn_getFlotante(&auxFloat,2,"\nIngrese el rodado: ","\nError reingrese el rodado: ",20,29))==0)
            ...
            if((utn_getEntero(&auxInt,2,"\nIngrese el cliente: ","\nError reingrese el cliente: ",100,104))==0)
           {
                auxBicicleta.idCliente=auxInt;
        ...
        if(todoOK==1)
        {
            ...
            clientes[indice].id=bicicletas[indice].idCliente;
...
void modificarBicicleta(eBicicleta bicicletas[],int tamBic,eTipo tipos[],int tamTip,eColor colores[],int tamCol,eCliente clientes[], int tamCli)
{
    int indice;
    int id;
    char confirma;
    ...
    {
        system("cls");
        mostrarBicicleta(bicicletas[indice],tipos,tamTip,colores,tamCol,clientes,tamCli);
...
void mostrarBicicleta(eBicicleta x,eTipo tipos[],int tamTip,eColor colores[],int tamCol,eCliente clientes[],int tamCli)
{
    ...
    printf("%d     %10s       %10s        %10s         %.2f    %10s\n", x.id,x.marca,nombreTipo, nombreColor, x.rodado, nombreCliente);
...
void mostrarBicicletas(eBicicleta vec[],int tam,eTipo tipos[],int tamTip,eColor colores[],int tamCol,eCliente clientes[],int tamCli)
{
    ...
    printf("id          Marca           Tipo               Color        Rodado     Nombre del cliente\n");
    for(int i=0;i<tam;i++)
    {
        if(vec[i].isEmpty == 0)
        {
...
void bajaBicicleta(eBicicleta bicicletas[],int tamBic,eTipo tipos[],int tamTip,eColor colores[],int tamCol,eCliente clientes[],int tamCli)
{
    int indice;
    int id;
    char confirma;
...
void ordenarBicicletas(eBicicleta vec[], int tam,eTipo tipos[],int tamTip,eColor colores[],int tamCol,eCliente clientes[],int tamCli)
{
    eBicicleta auxBicicleta;
    int orden;
...
int cargarNombreCliente(char nombre[], int id,eCliente clientes[], int tamCli)
{
    int todoOK=0;
